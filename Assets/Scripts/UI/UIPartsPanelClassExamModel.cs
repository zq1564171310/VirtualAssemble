...
namespace WyzLink.UI
{
    ...
    public class UIPartsPanelClassExamModel : MonoBehaviour, UIPartsPanelClass
    {
        ...
        public UIPartsPageExamModel _UIPartsPage;
        ...
        public void Init()
        {
            ...
            {
                NodeTypesList = NodesCommonExamModel.Instance.GetNodesTypes();  //初始化
            }
            else
            {
