...
namespace WyzLink.UI
{
    ...
    public class StartUIStudyModel : MonoBehaviour, StartUI
    {
        ...
        private AddPartsManagerStudyModel _AddPartsManager;            //零件初始化
        ...
        private UIPartsPanelClassStudyModel _UIPartsPanelClass;        //零件架初始化
        ...
        void Start()
        {
            ...
            _AddPartsManager = GameObject.Find("RuntimeObject").GetComponent<AddPartsManagerStudyModel>();
        ...
        public void Restart()
        {
            ...
            AssembleManagerStudyModel.Instance.GetTipCanvas(_TipErrorPlane);    //提示框被隐藏了，所以初始化的时候，把被隐藏的物体赋值，否则后续将无法调用该物体
            AssembleManagerStudyModel.Instance.GetTipErrBtn(_TipErrBtn);

            AssembleManagerStudyModel.Instance.GetPartsInfoPlane(_PartsInfoPlane);
            AssembleManagerStudyModel.Instance.GetPartsInfoText(_PartsInfoText);
            AssembleManagerStudyModel.Instance.GetPartsInfoBtn(_PartsInfoBtn);

            AssembleManagerStudyModel.Instance.Init();                    //安装处理类初始化
        }
